...
- P2P Messaging is a public collaborative work in progress. The portfolio documents its local browser workspace, verified contacts, encrypted and signed direct messages, authenticated replies, encrypted history, signed attachment references, transport safeguards, 75-test evidence, and major missing production guarantees without presenting it as audited software.
