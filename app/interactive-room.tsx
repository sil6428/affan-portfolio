...
const ROOM_ENTRIES: Record<string, RoomEntry> = {
  ...
  profile: {
    ...
    links: [
      ...
      { label: "Resume", href: "/Affan_Shaikh_Resume.pdf?v=2026-09-01-clear-project" },
    ],
    cameraOffset: [0, 0.1, 3.05],
    targetOffset: [0, 0, 0],
  },
  ...
  resume: {
    ...
    links: [{ label: "Open resume PDF", href: "/Affan_Shaikh_Resume.pdf?v=2026-09-01-clear-project" }],
    cameraOffset: [0, 0.1, 3.05],
    targetOffset: [0, 0, 0],
  },
  inspiration: {
