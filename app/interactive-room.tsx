...
const ROOM_ENTRIES: Record<string, RoomEntry> = {
  ...
  profile: {
    ...
    links: [
      ...
      { label: "Resume", href: "/Affan_Shaikh_Resume.pdf?v=2026-09-11-cloud-iam" },
    ],
    cameraOffset: [0, 0.1, 3.05],
    targetOffset: [0, 0, 0],
  },
  ...
  resume: {
    ...
    label: "DOCUMENT / PDF",
    title: "Resume",
    summary: "My current cloud security, secure communications, networking, co-founder, technical-operations, and education resume.",
    details: ["Ontario Tech 2028", "Cybersecurity", "SSIK co-founder", "Technical operations"],
    sections: [
      {
        heading: "Current direction",
        body: "The resume covers my cloud IAM auditor, secure messaging and transfer projects, networking skills, SSIK co-founder work, nonprofit technology operations, customer-facing experience, and community volunteering.",
      },
    ],
    links: [{ label: "Open resume PDF", href: "/Affan_Shaikh_Resume.pdf?v=2026-09-11-cloud-iam" }],
    cameraOffset: [0, 0.1, 3.05],
    targetOffset: [0, 0, 0],
  },
  inspiration: {
