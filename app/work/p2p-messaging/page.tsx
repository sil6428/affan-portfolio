...
export const metadata: Metadata = {
  ...
  description: "A collaborative, security-focused Python messaging prototype with verified peer identities, authenticated encryption, replay protection, and 72 automated tests.",
};
...
const data = {
  ...
  facts: [
    ...
    ["Verification", "72 automated tests"],
